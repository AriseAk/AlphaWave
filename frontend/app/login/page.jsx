        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-white rounded-2xl shadow-xl border border-blue-100 p-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-10 py-3 border border-blue-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition"
                    placeholder="••••••••"
                  />
                  <button
            ...
            <div className="grid grid-cols-2 gap-4">
              <button onClick={handleGoogle} className="flex items-center justify-center px-4 py-3 border border-blue-200 rounded-lg hover:bg-blue-50 transition">
              ...
              <button className="flex items-center justify-center px-4 py-3 border border-blue-200 rounded-lg hover:bg-blue-50 transition">
